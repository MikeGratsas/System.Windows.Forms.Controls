    ...
    public class StatusBarPanel : Component, ISupportInitialize
    {
        ...
        public Icon Icon
        {
            ...
            set
            {
                ...
                if (Created)
                {
                    ...
                    User32.SendMessageW(parent, NativeMethods.SB_SETICON, (IntPtr)GetIndex(), handle);
        ...
        internal void Realize()
        {
            if (Created)
            {
                ...
                {
                    User32.SendMessageW(parent, NativeMethods.SB_SETICON, (IntPtr)GetIndex(), icon.Handle);
                }
                else
                {
                    User32.SendMessageW(parent, NativeMethods.SB_SETICON, (IntPtr)GetIndex(), IntPtr.Zero);
                }
