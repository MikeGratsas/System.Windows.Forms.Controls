...
*/
        ...
        private bool DataGridSourceHasErrors()
        {
            ...
            {
                object errObj = listManager.List[i];
        ...
        private void DataSource_ItemChanged(object sender, ItemChangedEventArgs ea)
        {
            ...
            else
            {
                ...
                object errObj = listManager.List[ea.Index];
                bool oldListHasErrors = ListHasErrors;
                if (errObj is IDataErrorInfo)
                {
        ...
        */
        ...
        private void ColumnHeaderClicked(PropertyDescriptor prop)
        {
            ...
            ListSortDirection direction = ListSortDirection.Ascending;// ListManager.GetSortDirection();
            PropertyDescriptor sortColumn = null;// ListManager.GetSortProperty();
            IBindingList list = ListManager.List as IBindingList;
            if (list != null && list.SupportsSorting)
            {
                direction = list.SortDirection;
                sortColumn = list.SortProperty;
            }
