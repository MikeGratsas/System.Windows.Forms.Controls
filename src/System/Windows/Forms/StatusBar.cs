    ...
    public class StatusBar : Control
    {
            ...
            set
            {
                if (showPanels != value)
                {
                    ...
                    if (IsHandleCreated)
                    {
                        ...
                        User32.SendMessageW(this, NativeMethods.SB_SIMPLE, (IntPtr)bShowPanels, IntPtr.Zero);
        ...
        private void ApplyPanelWidths()
        {
            ...
            if (length == 0)
            {
                ...
                User32.SendMessageW(this, NativeMethods.SB_SETICON, IntPtr.Zero, IntPtr.Zero);
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            if (!showPanels)
            {
                User32.SendMessageW(this, NativeMethods.SB_SIMPLE, (IntPtr)1, IntPtr.Zero);
                SetSimpleText(simpleText);
            }
            else
            {
        ...
        internal void RealizePanels()
        {
            ...
            if (length == 0)
            {
                User32.SendMessageW(this, NativeMethods.SB_SETTEXT, IntPtr.Zero, IntPtr.Zero);
            }
        ...
        private void SetSimpleText(string simpleText)
        {
            if (!showPanels && IsHandleCreated)
            {
                ...
                User32.SendMessageW(this, NativeMethods.SB_SETTEXT, (IntPtr)wparam, simpleText);
            }
        }
        ...
        ///  full controls.
        /// </summary>
        private class ControlToolTip : IWin32Window
        {
            public class Tool
            {
            ...
            private void AddTool(Tool tool)
            {
                if (tool != null && tool.text != null && tool.text.Length > 0)
                {
                    ...
                    if (info.SendMessage(p.ToolTipSet ? (IWin32Window)p.mainToolTip : this, WindowMessages.TTM_ADDTOOLW) == IntPtr.Zero)
                    {
