...
namespace System.Windows.Forms
{
    ...
    public class ToolBarButton : Component
    {
        ...
        internal class ToolBarButtonImageIndexer : ImageListIndexer
        {
        ...
        public bool Enabled
        {
            ...
            set
            {
                if (enabled != value)
                {
                    ...
                    {
                        User32.SendMessageW(parent, NativeMethods.TB_ENABLEBUTTON, (IntPtr)FindButtonIndex(),
                            (IntPtr)(enabled ? 1 : 0));
                    }
                }
            }
        ...
        public bool PartialPush
        {
            get
            {
                ...
                {
                    if (User32.SendMessageW(parent, NativeMethods.TB_ISBUTTONINDETERMINATE, (IntPtr)FindButtonIndex(), IntPtr.Zero) != IntPtr.Zero)
                    {
                        partialPush = true;
                    }
                    else
        ...
        {
            if (User32.SendMessageW(parent, NativeMethods.TB_ISBUTTONCHECKED, (IntPtr)FindButtonIndex(), IntPtr.Zero) != IntPtr.Zero)
            {
                pushed = true;
            }
            else
