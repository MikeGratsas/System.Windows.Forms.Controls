...
internal static partial class Interop
{
    internal static partial class User32
    {
        ...
        public unsafe static int MapWindowPoint(IWin32Window hWndFrom, IWin32Window hWndTo, ref Point lpPoints)
        {
        ...
        public unsafe static int MapWindowPoint(IWin32Window hWndFrom, IntPtr hWndTo, ref Point lpPoints)
        {
            fixed (Point* p = &lpPoints)
            {
        ...
        public unsafe static int MapWindowPoint(IntPtr hWndFrom, IWin32Window hWndTo, ref Point lpPoints)
        {
            fixed (Point* p = &lpPoints)
            {
        ...
        public unsafe static int MapWindowPoints(IWin32Window hWndFrom, IntPtr hWndTo, ref RECT lpPoints)
        {
            fixed (RECT* r = &lpPoints)
            {
        ...
        public unsafe static int MapWindowPoints(IntPtr hWndFrom, IWin32Window hWndTo, ref RECT lpPoints)
        {
            fixed (RECT* r = &lpPoints)
            {
